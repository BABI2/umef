    ...
    public class SubscribersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subscribers != null ? 
                          ...
                          Problem("Entity set 'DataContext.Subscribers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,FullName,DateInscription")] Subscriber subscriber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,FullName,DateInscription")] Subscriber subscriber)
        {
            if (id != subscriber.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.Subscribers'  is null.");
            }
            var subscriber = await _context.Subscribers.FindAsync(id);
            if (subscriber != null)
            {
